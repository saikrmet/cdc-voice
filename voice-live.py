    ...
    session_update = {
        ...
        "session": {
            ...
            "turn_detection": {
                ...
                # Removed end_of_utterance_detection – not supported outside cascaded pipelines
            },
        ...
        # Removed event_id (server will assign IDs)
    }
    ...
    try:
        ...
        while not stop_event.is_set():
            if stream.read_available >= read_size:
                ...
                # Ensure we base64-encode raw PCM16 bytes
                audio = base64.b64encode(data.tobytes()).decode("utf-8")
                param = {"type": "input_audio_buffer.append", "audio": audio}
    ...
    try:
        while not stop_event.is_set():
            ...
            try:
                ...
                # Print the type plainly (avoid printing a set)
                ...
                if event.get("type") == "session.created":
                ...
                elif event.get("type") in ("response.audio.delta", "response.output_audio.delta"):
                    ...
                    # Surface full error payload for diagnosis
                    try:
                        print("Error event payload:\n" + json.dumps(event, indent=2))
                    except Exception:
                        print(f"Error event payload (raw): {event}")
